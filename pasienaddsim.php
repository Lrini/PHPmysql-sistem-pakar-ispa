...
elseif (trim($TxtUmur)=="") {
	include "pasienaddfm.php";
	echo '<div class="isi col-md-5 col-md-offset-7 alert alert-danger role=alert">
	Umur belum diisi, ulangi kembali
	</div></br>';
}
...
elseif (trim($TxtPekerjaan)=="") {
	...
	$sql  = " INSERT INTO tmp_pasien (nama,kelamin,umur,alamat,pekerjaan,noip,tanggal) 
		 	  VALUES ('$TxtNama','$RbKelamin', '$TxtUmur','$TxtAlamat','$TxtPekerjaan','$NOIP',NOW())";

...
<!-- header start -->
<div class="atas">
<div class="logo"><a href="index.php"><a href="index.php"><a href="index.php"><img src="images/ISPA.jpg"></a></div>
</div>
<!-- header end -->
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Sistem Pakar Diagnosa  ISPA</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-2">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="?page=daftar">Dignosa</a></li>
            <li><a href="?page=dafpenyakit">Informasi</a></li>
...
<div class="bawah"><div class="copy">
            <p> Sistem Pakar Diagnosa Penyakit ISPA @copyright NPDPN </p>
        </div>
    </div>
<!-- footer end -->

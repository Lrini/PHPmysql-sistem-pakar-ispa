...
<nav class="navbar navbar-inverse navbar-static-top">
  ...
  <div class="panel-body">
  SELAMAT DATANG di Sistem Pakar Diagnosa Penyakit ISPA! Sistem ini bertujuan untuk membantu pengguna dalam mendiagnosa penyakit Infeksi Saluran Pernapasan Akut(ISPA) sebagai langkah awal pencegahan ISPA agar tidak bertambah parah. 
  </div>
</div>
      </div>

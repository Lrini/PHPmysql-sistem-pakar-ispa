...
<form name="form1" method="post" action="GejalaEditSim.php">
  <table class="table table-striped">
    ...
    <tr> 
      <td>&nbsp;</td>
      <td><input class="btn btn-sm btn-success raised"  type="submit" name="Submit" value="SIMPAN">        <a class="btn btn-sm btn-warning raised" href="GejalaTampil.php">kembali</a>
      </td>
    </tr>
  </table>

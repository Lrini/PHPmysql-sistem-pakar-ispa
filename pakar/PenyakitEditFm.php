      ...
      <div class="side-menu-container">
        <ul class="nav navbar-nav">
         ...
         <!-- Dropdown akusisi pengetahuan-->
          <li class="panel panel-default" id="dropdown">
            <a data-toggle="collapse" href="#dropdown-akusisi pengetahuan">
...
<tr > 
  <td>&nbsp;</td>
  <td><input class="btn btn-sm btn-success raised" type="submit" name="Submit" value="SIMPAN">    <a class="btn btn-sm btn-warning raised" href="PenyakitTampil.php">kembali</a>
  </td>
